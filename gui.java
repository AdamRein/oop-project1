...
public class gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        testingList = new javax.swing.JTextField();
        ...
        addCourseButton1.setText("TESTING LIST");
        addCourseButton1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                addCourseButton1MouseClicked(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addComponent(testingList, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(testingList, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTextField34, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void searchStudentButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchStudentButtonMouseClicked
        ...
        for (Student student : gui.studentList) {
            if (student.getName().equals(studentName)) {
                jTextField22.setText(student.getDOB());
                jTextField32.setText(student.get_program().toString());
                jTextField34.setText(student.get_course_list().toString());
                jTextField24.setText(student.get_start_date());
                jTextField25.setText(student.get_advisor());
            }
        }
    ...
    private void searchCourseButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchCourseButtonMouseClicked
        // TODO add your handling code here:
        String courseName = jTextField23.getText();
        for (Course course : courseOfList) {
            if (course.getName().equals(courseName)) {
                jTextField29.setText(course.getProgram().toString());
                jTextField30.setText(course.getPrerequisiteList().toString());
                jTextField31.setText(course.getInstructor().toString());
                jTextPane4.setText(course.getStudentList().toString());
            }
        }
    ...
    private void searchInstructorButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchInstructorButtonMouseClicked
        // TODO add your handling code here:
        String instructorName = jTextField26.getText();
        for (Instructor instructor : gui.instructorList) {
            if (instructor.getName().equals(instructorName)) {
                jTextField27.setText(instructor.getDOB());
                jTextField28.setText(instructor.getProgram().toString());
                jTextPane2.setText(instructor.getCourseList().toString());
                jTextPane3.setText(instructor.getAdvisees().toString());
            }
        }
    ...
    private void addCourseButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addCourseButtonMouseClicked
        // TODO add your handling code here:
        String courseName = jTextField16.getText();
        String programName = jTextField17.getText();
        //String preReqNames = jTextField18.getText();

        String[] coursePrerequisiteList = jTextField18.getText().split(",");
    ...
    private void addInstructorButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addInstructorButtonMouseClicked
        // TODO add your handling code here:
        String instructorName = jTextField11.getText();
        String DOB = jTextField12.getText();
        String programName = jTextField13.getText();
    ...
    private void addStudentButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addStudentButtonMouseClicked
        ...
        String programName = jTextField7.getText();
        String startDate = jTextField9.getText();
    ...
    private void addProgramButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addProgramButtonMouseClicked
        String programName = jTextField1.getText();
        String college = jTextField2.getText();
        String type = jTextField3.getText();
        String credits = jTextField4.getText();
    ...
    private void addCourseButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addCourseButton1MouseClicked
        // TODO add your handling code here:
          StringBuilder studentCourses = new StringBuilder();

    // Iterate through the instructorList
    for (Student student : gui.studentList) {
        // Append the name of each instructor to the StringBuilder
        studentCourses.append(student.get_course_list()).append("\n");
    }

    // Set the text of the JTextField to the names of all instructors
    testingList.setText(studentCourses.toString());

    }//GEN-LAST:event_addCourseButton1MouseClicked
    ...
    private javax.swing.JTextField testingList;
